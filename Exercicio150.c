...
int findLargestProduct(int matrix[ROWS][COLS]) {
    int maxProduct = 0;
...
int main() {
    ...
    int largestProduct = findLargestProduct(matrix);

    printf("O maior produto de quatro números adjacentes em qualquer direção é: %d\n", largestProduct);
